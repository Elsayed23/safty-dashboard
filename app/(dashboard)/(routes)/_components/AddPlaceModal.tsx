    ...
    return (
        <Dialog>
            <DialogTrigger asChild>
                <Button className='bg-transparent border-[#FE5000] text-[#FE5000] uppercase ml-10 flex items-center gap-2 hover:bg-transparent'>Add place  <CirclePlus size={18} /></Button>
            </DialogTrigger>
